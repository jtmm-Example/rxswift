...
//  Life
//
//  Created by yyy on 2019/6/12.
//  Copyright © 2019 yyy. All rights reserved.
//

//MARK: - copy地址：https://github.com/scalessec/Toast-Swift
...
public extension UIView {
    ...
    func makeToast(_ message: String?, duration: TimeInterval = ToastManager.shared.duration, position: ToastPosition = ToastManager.shared.position, title: String? = nil, image: UIImage? = nil, style: ToastStyle = ToastManager.shared.style, completion: ((_ didTap: Bool) -> Void)? = nil) {
        do {
            ...
            print("错误：message，title和image不可全部为空")
        } catch {}
    }
    ...
    private func showToast(_ toast: UIView, duration: TimeInterval, point: CGPoint) {
        self.isUserInteractionEnabled = ToastManager.shared.isUserInteractionEnabledWhenShow
...
public class ToastManager {
    ...
    /**
     toastView展示的时候停止superView的交互，默认true
     设置为false后isQueueEnabled、isTapToDismissEnabled不生效
     */
    public var isUserInteractionEnabledWhenShow = true
